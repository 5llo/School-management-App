...
// Method to parse the time string into TimeOfDay
  ...
  getData() async {
    ...
    var response = await weekdata.getdata();
    ...
    if (statusrequest == Statusrequest.success) {
      if (response['data'] == null) {
        ...
        Map<String, dynamic> rawWeek = data['week_schedule'];
        ...
        // استخراج جدول الامتحانات
        Map<String, dynamic> rawExams = data['exam_schedule'];
        examSchedule = {
          for (var key in rawExams.keys)
            key: Weekmodel.fromJson(rawExams[key])
        };
      }
    }
    update();
