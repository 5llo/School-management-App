import 'package:e_commerce/controller/parent/parentschoolratingcontroller.dart';
...
class SchoolRatingPage extends StatelessWidget {
  final String childrenId;

  const SchoolRatingPage({super.key, required this.childrenId});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SchoolRatingController>(
      init: SchoolRatingController(),
      builder: (controller) {
        return Scaffold(
          backgroundColor: const Color(0xFFF9F9F9),
          appBar: AppBar(
            title: const Text('تقييم المدرسة'),
          ),
          body: Column(
            children: [
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                hintText: 'شارك رأيك حول أداء المدرسة...',
